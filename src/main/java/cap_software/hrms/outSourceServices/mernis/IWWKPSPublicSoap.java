...
public class IWWKPSPublicSoap
{
    ...
    public IWWKPSPublicSoap(){}

    public IWWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IWWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IWWExtendedSoapSerializationEnvelope envelope= new IWWExtendedSoapSerializationEnvelope(IWWExtendedSoapSerializationEnvelope.VER11);
