...
public class IWWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IWWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IWWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IWWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IWWDateTimeConverter dateTimeConverter = new IWWStandardDateTimeConverter();

    public IWWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IWWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IWWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IWWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IWWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IWWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
