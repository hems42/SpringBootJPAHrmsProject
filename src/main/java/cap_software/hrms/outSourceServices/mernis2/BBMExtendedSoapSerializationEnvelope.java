...
public class BBMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BBMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BBMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BBMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BBMDateTimeConverter dateTimeConverter = new BBMStandardDateTimeConverter();

    public BBMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BBMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BBMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BBMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BBMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BBMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
