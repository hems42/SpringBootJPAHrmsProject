...
public class BBMKPSPublicSoap
{
    ...
    public BBMKPSPublicSoap(){}

    public BBMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BBMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BBMExtendedSoapSerializationEnvelope envelope= new BBMExtendedSoapSerializationEnvelope(BBMExtendedSoapSerializationEnvelope.VER11);
