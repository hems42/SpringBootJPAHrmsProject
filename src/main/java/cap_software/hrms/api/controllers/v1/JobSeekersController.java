...
public class JobSeekersController {
    ...
    @PostMapping
    public ResponseEntity<DataResult<JopSeekerDto>> createJopSeeker(@RequestBody CreateJopSeekerRequest createJopSeekerRequest) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<JopSeeker> updateJopSeeker(@RequestParam Integer id, @RequestBody UpdateJopSeekerRequest updateJopSeekerRequest)
    {
